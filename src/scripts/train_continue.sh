...
TRAIN_FILE=/mnt/blob_nixinzhe/llm_sota_data/sota_json/sota_v10.jsonl
OUTPUT_DIR=/mnt/blob_nixinzhe/checkpoints/a100-deepseek-7b-v10-8
mkdir -p $OUTPUT_DIR
...
accelerate launch \
    ...
    /mnt/blob_nixinzhe/ToRA/src/train/finetune_continue.py \
    --model_name_or_path ${MODEL_PATH} \
    --resume_from_checkpoint /mnt/blob_nixinzhe/checkpoints/a100-deepseek-7b-v10-1/step_30000 \
